...
function sheet(){
 ...
 const j=journey,sim=simulationSummary(j),map=worldMapSummary(j);const elapsed=`${Math.floor(j.elapsedMonths/12)}y ${j.elapsedMonths%12}m`;
